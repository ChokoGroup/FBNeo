...
OUTPUT_ARCH(arm)
ENTRY(_start)
SEARCH_DIR("=/__w/FBNeo/FBNeo/.build/install/armv7-rpi2-linux-gnueabihf/armv7-rpi2-linux-gnueabihf/lib"); SEARCH_DIR("=/usr/local/lib"); SEARCH_DIR("=/lib"); SEARCH_DIR("=/usr/lib");
SECTIONS
{
